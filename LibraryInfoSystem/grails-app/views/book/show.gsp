	...
	<body>
		...
		<div id="show-book" class="content scaffold-show" role="main">
			...
			<ol class="property-list book">
				...
				<g:if test="${bookInstance?.students}">
				<li class="fieldcontain">
					<span id="students-label" class="property-label"><g:message code="book.students.label" default="Students" /></span>
					
						<g:each in="${bookInstance.students}" var="s">
