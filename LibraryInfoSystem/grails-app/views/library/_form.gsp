<%@ page import="com.libraryinfosystem.Library" %>
...
<div class="fieldcontain ${hasErrors(bean: libraryInstance, field: 'book', 'error')} required">
	...
	<g:select id="book" name="book.id" from="${com.libraryinfosystem.Book.list()}" optionKey="id" required="" value="${libraryInstance?.book?.id}" class="many-to-one"/>
...
<div class="fieldcontain ${hasErrors(bean: libraryInstance, field: 'librarian', 'error')} required">
	...
	<g:select id="librarian" name="librarian.id" from="${com.libraryinfosystem.Librarian.list()}" optionKey="id" required="" value="${libraryInstance?.librarian?.id}" class="many-to-one"/>
...
<div class="fieldcontain ${hasErrors(bean: libraryInstance, field: 'books', 'error')} ">
	...
	<g:select name="books" from="${com.libraryinfosystem.Book.list()}" multiple="multiple" optionKey="id" size="5" value="${libraryInstance?.books*.id}" class="many-to-many"/>
...
<div class="fieldcontain ${hasErrors(bean: libraryInstance, field: 'librarians', 'error')} ">
	...
	<g:select name="librarians" from="${com.libraryinfosystem.Librarian.list()}" multiple="multiple" optionKey="id" size="5" value="${libraryInstance?.librarians*.id}" class="many-to-many"/>
...
<div class="fieldcontain ${hasErrors(bean: libraryInstance, field: 'student', 'error')} required">
	...
	<g:select id="student" name="student.id" from="${com.libraryinfosystem.Student.list()}" optionKey="id" required="" value="${libraryInstance?.student?.id}" class="many-to-one"/>
...
<div class="fieldcontain ${hasErrors(bean: libraryInstance, field: 'students', 'error')} ">
	...
	<g:select name="students" from="${com.libraryinfosystem.Student.list()}" multiple="multiple" optionKey="id" size="5" value="${libraryInstance?.students*.id}" class="many-to-many"/>
